...
Currently supported models are described in Table~\ref{tab:models}. The \code{partial.default} method, however, should be able to handle most other types of models; for example, neural networks from the \CRANpkg{nnet} package \citep{venables-modern-2002} or projection pursuit regression \citep{friedman-ppr-1981} using the \code{ppr} function in the \pkg{stats} package.
\begin{table}[htbp]
