...
\begin{widefigure}[htbp]
  ...
  \caption{Partial dependence of \code{cmedv} on \code{lstat} and \code{rm} based on a third degree MARS model. \textit{Left}: Default plot. \textit{Middle}: Using a user-specified color palette. \textit{Right}: Using a 3-D surface.}
