...
\end{example}
The development version is located on GitHub: \url{https://github.com/bgreenwell/pdp}. Bug reports and suggestions are appreciated and should be submitted to \url{https://github.com/bgreenwell/pdp/issues}. Currently, only three functions are exported by \pkg{pdp}:
\begin{itemize}
  \item \code{partial}
...
Finally, \code{multiplot} is a simple helper function that makes it easier to display multiple PDPs on a single plot.
