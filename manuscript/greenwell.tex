...
summary(ozone.earth)
\end{example}
The model produced a generalized $R^2$ of $0.788$, similar to what was reported in \citet{breiman-1985-estimating}. A single three-way interaction was found involving the predictors
\begin{itemize}
