...
\begin{widefigure}[htbp]
  ...
  \caption{Partial dependence of \code{cmedv} on \code{lstat} and \code{rm}. \textit{Left}: Default plot. \textit{Middle}: With contour lines and a different color palette. \textit{Right}: Using a 3-D surface.}
