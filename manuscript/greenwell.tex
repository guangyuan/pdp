...
\strong{Mention the integral approximation!!}
...
\end{example}
The development version is located on GitHub: \url{https://github.com/bgreenwell/pdp}. Bug reports and usggestions are appreciated and should be sumbitted to \url{https://github.com/bgreenwell/pdp/issues}.
...
\begin{table}[htbp]
  \begin{tabular}{p{4cm}ll}
    \toprule
      ...
      \bottomrule
  \end{tabular}
  \caption{Models specifically supported by the \pkg{package}. \strong{Note:} package \pkg{xgboost} is only partially supported; see Section~\ref{sec:xgboost} fr details.}
  \label{tab:models}
\end{table}
